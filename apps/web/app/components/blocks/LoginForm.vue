...
<template>
    <div :class="cn('flex flex-col gap-6', props.class)">
                    ...
                    <FieldGroup>
                        ...
                        <Field class="grid grid-cols-3 gap-4">
                            <Button variant="outline" type="button">
                                ...
                                <span class="sr-only">Iniciar sesión con Apple</span>
                            </Button>
                            <Button variant="outline" type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path
                            ...
                            <Button variant="outline" type="button">
                                ...
                                <span class="sr-only">Iniciar sesión con Meta</span>
                            </Button>
                        </Field>
        ...
        <FieldDescription class="px-6 text-center">
            Aplicativo desarrollado por <a href="https://orcronics.com" target="_blank">Orcronics</a> - Todos los
            derechos reservados.
        </FieldDescription>
    </div>
</template>
